...
class ComplaintsTest < ApplicationSystemTestCase
  ...
  test "creating a Complaint" do
    ...
    fill_in "Invoice", with: @complaint.invoice
    fill_in "Issue date", with: @complaint.issue_date
    fill_in "Lot", with: @complaint.lot
    fill_in "Notes", with: @complaint.notes
    fill_in "Order", with: @complaint.order
    fill_in "Status", with: @complaint.status
    fill_in "User", with: @complaint.user
    check "With vendor" if @complaint.with_vendor
